...
def extract_api():
    ...
    # Clean API connection endpoints
    ...
    try:
        ...
        # FIXED: Removed the malformed string formatting parameters entirely
        try:
            ...
            return jsonify({"success": False, "error": f"Ad-free infrastructure communication timeout. Please retry."}), 500
