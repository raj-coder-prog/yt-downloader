...
<head>
    ...
    <style>
        ...
        .search-wrapper { background: var(--card); border-radius: 16px; padding: 8px; display: flex; width: 100%; max-width: 580px; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05); box-sizing: border-box; margin-bottom: 24px; border: 1px solid #e2e8f0; }
...
def extract_api():
    ...
    if not download_url:
        return jsonify({"success": False, "error": "Unable to isolate direct MP4 source links for this video."}), 400
